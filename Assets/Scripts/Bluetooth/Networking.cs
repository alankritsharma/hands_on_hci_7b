// PART OF THE Shatalmic Bluetooth Networking Plugin!
using System;
...
namespace Shatalmic
{
    ...
    {
        protected float _timeout = 0f;
        protected States _state = States.None;
        protected NetworkDevice _deviceToConnect = null;
        protected NetworkDevice _deviceToDisconnect = null;
        ...
        protected void SetState(States newState, float timeout)
        {
            _state = newState;
            _timeout = timeout;
        }
        ...
        protected bool _serverStarted = false;
