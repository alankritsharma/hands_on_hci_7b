...
public class AlignmentManager : MonoBehaviour
{
    ...
    private Vector3 alignedParentScale;
    ...
    public void NextStep(Vector3? pointerOverride = null)
    {
        ...
        else
        {
            ...
            this.alignedParentScale = this.fineTuningParent.localScale;
    ...
    public void Realign(bool restartFineTuning)
    {
        ...
        this.fineTuningParent.localScale = this.alignedParentScale;

        // allow fine tuning again to check the alignment between iterations
        if (restartFineTuning) this.fineTuningDone = false;
